package ru.scheduled.mediaattachmentslibrary.widgets.mediatoolbarview
...
import ru.scheduled.mediaattachmentslibrary.databinding.LayoutMediaToolbarViewBinding
import ru.scheduled.mediaattachmentslibrary.utils.hideKeyboard
import ru.scheduled.mediaattachmentslibrary.widgets.ToolTip
import ru.scheduled.mediaattachmentslibrary.widgets.voice.VoiceRecorder
import java.io.File
...
private const val toolbarResetAnimationDuration = 300L
private const val toolbarHeightChangeDelay = 10L
...
class MediaToolbarView : ConstraintLayout {
    ...
    fun showMediaEditingToolbar(isCopyable: Boolean, isEditable: Boolean) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            onNewToolbarHeight?.invoke(binding.mediaToolbarDefault.root.height)
