...
class PositionAnimExpectationAlignBottom(otherView: View) : PositionAnimationViewDependant(otherView) {
    ...
    override fun getCalculatedValueY(viewToMove: View): Float? {
        return viewCalculator!!.finalPositionBottomOfView(otherView) - getMargin(viewToMove) - viewToMove.height.toFloat()
    }
}
